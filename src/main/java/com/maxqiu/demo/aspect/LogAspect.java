package com.maxqiu.demo.aspect;
...
public class LogAspect {
    @Resource
    private LogOperationService operLogService;
     ...
     * @throws Exception
     */
    public void getControllerMethodDescription(JoinPoint joinPoint, Log log, LogOperation operLog, Object jsonResult) throws Exception {
        // 设置action动作
